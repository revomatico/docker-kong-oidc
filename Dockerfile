...
RUN yum update -y && yum install -y unzip wget ${PACKAGES} \
## Install plugins
...
" "$TPL" \
 # Build kong-http-to-https-redirect
    && wget https://raw.githubusercontent.com/dsteinkopf/kong-http-to-https-redirect/repo-dsteinkopf/kong-http-to-https-redirect-${KHTHR_VER}.rockspec \
